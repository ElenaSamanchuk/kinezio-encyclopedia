...
export function Moment() {
  return (
    <section data-kin-reveal className="kin-bleed kin-bleed-dark relative mt-[120px] h-[363px] w-full bg-[#14161a]">
      ...
      <p className="absolute left-[120px] top-[80px] w-[372px] text-[16px] font-bold leading-[normal] text-white">
        {MOMENT.kicker}
      </p>
