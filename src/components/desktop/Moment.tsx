...
export function Moment() {
  return (
    <section className="relative mt-[120px] h-[363px] w-full overflow-hidden">
      ...
      <p className="absolute left-[140px] top-[80px] w-[372px] text-[16px] font-bold leading-[normal] text-white">
        {MOMENT.kicker}
      </p>
      <h2 className="font-display absolute left-[140px] top-[211px] w-[483px] text-[30px] uppercase leading-[1.2] text-white">
        {MOMENT.titleLine1}
        <br />
        {MOMENT.titleLine2}
      </h2>

      <div className="absolute left-[630px] top-[80px] flex w-[670px] flex-wrap content-center items-center gap-[18px]">
        {MOMENT.items.map((item) => (
          <div
            key={item.n}
            className="flex w-[326px] items-center gap-[20px] rounded-[16px] bg-[#1f2126] p-[20px]"
          >
