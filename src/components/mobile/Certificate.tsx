...
export function Certificate() {
  return (
    <section className="relative mt-[68px] h-[623px] w-[430px] overflow-hidden bg-white">
      ...
      />
      <p className="absolute left-[12px] top-[608px] w-[402px] -translate-y-full text-[14px] font-normal leading-[1.3] text-white">
        {CERTIFICATE.note}
      </p>
    </section>
  );
