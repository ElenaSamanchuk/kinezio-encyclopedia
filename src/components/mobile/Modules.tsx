    ...
    <section data-kin-reveal id="program" className="mx-auto kin-gap flex w-[406px] flex-col items-start gap-[24px]">
      ...
      <div className="flex w-full flex-col items-start gap-[16px]">
        ...
        <Card
          ...
          body={
            <>
              <span className="block leading-[18px]">{m4.bodyIntro}</span>
              <ul className="list-disc">
                {m4.bodyList.map((li, i) => (
                  <li key={li} className="ms-[21px] leading-[18px]">
  ...
  return (
    <article className="flex w-full flex-col items-start gap-[24px] rounded-[16px] bg-white p-[16px]">
      <div className="flex w-full flex-col items-start gap-[12px]">
        <p className="w-full text-[12px] font-extrabold leading-[14px] text-[#ff6332]">{label}</p>
        <h3 className="font-display w-full text-[16px] uppercase leading-[19px] text-[#242424]">
          {title}
        </h3>
        <p className="w-full text-[14px] font-semibold leading-[18px] text-[#8a8e96]">{lead}</p>
      </div>
      <div className="w-full text-[14px] font-semibold leading-[18px] text-[#242424]">{body}</div>
    </article>
  );
}
